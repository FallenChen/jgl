...
public class VHashSetIterator extends com.objectspace.voyager.VObject implements com.objectspace.jgl.ForwardIterator, com.objectspace.jgl.Opaque
  {
  private static final com.objectspace.voyager.util.Token __classname = new com.objectspace.voyager.util.Token( "com.objectspace.jgl.HashSetIterator" );
  private static final com.objectspace.voyager.util.Token __class0 = new com.objectspace.voyager.util.Token( "<init>()" );
  private static final com.objectspace.voyager.util.Token __class1 = new com.objectspace.voyager.util.Token( "<init>(Lcom.objectspace.jgl.HashSetIterator;)" );
  ...
  private static final com.objectspace.voyager.util.Token __instance9 = new com.objectspace.voyager.util.Token( "put(ILjava.lang.Object;)V" );
  ...
  private static final com.objectspace.voyager.util.Token __instance12 = new com.objectspace.voyager.util.Token( "getContainer()Lcom.objectspace.jgl.Container;" );
  private static final com.objectspace.voyager.util.Token __instance13 = new com.objectspace.voyager.util.Token( "isCompatibleWith(Lcom.objectspace.jgl.InputIterator;)Z" );
  private static final com.objectspace.voyager.util.Token __instance14 = new com.objectspace.voyager.util.Token( "opaqueData()Ljava.lang.Object;" );
  private static final com.objectspace.voyager.util.Token __instance15 = new com.objectspace.voyager.util.Token( "opaqueId()I" );
  
  static
    {
    __register( new VHashSetIterator() );
    }
   ...
   */
  public VHashSetIterator( com.objectspace.voyager.space.VSubspace reference ) throws com.objectspace.voyager.VoyagerException
    {
   ...
   * @exception com.objectspace.voyager.VoyagerException A voyager-related exception occurred.
   */
  public VHashSetIterator( String __address, long __timeout ) throws com.objectspace.voyager.VoyagerException
    {
   ...
   * @exception com.objectspace.voyager.VoyagerException A voyager-related exception occurred.
   */
  public VHashSetIterator( String __address ) throws com.objectspace.voyager.VoyagerException
    {
   ...
   * @exception com.objectspace.voyager.VoyagerException A voyager-related exception occurred.
   */
  public VHashSetIterator( com.objectspace.jgl.HashSetIterator arg1, String __address, long __timeout ) throws com.objectspace.voyager.VoyagerException
    {
    com.objectspace.voyager.message.Messenger __messenger = __newConstructorDefaultMessenger();
   ...
   * @exception com.objectspace.voyager.VoyagerException A voyager-related exception occurred.
   */
  public VHashSetIterator( com.objectspace.jgl.HashSetIterator arg1, String __address ) throws com.objectspace.voyager.VoyagerException
    {
