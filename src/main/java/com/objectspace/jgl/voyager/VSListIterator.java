...
public class VSListIterator extends com.objectspace.voyager.VObject implements com.objectspace.jgl.ForwardIterator, com.objectspace.jgl.Opaque
  {
  private static final com.objectspace.voyager.util.Token __classname = new com.objectspace.voyager.util.Token( "com.objectspace.jgl.SListIterator" );
  private static final com.objectspace.voyager.util.Token __class0 = new com.objectspace.voyager.util.Token( "<init>()" );
  private static final com.objectspace.voyager.util.Token __class1 = new com.objectspace.voyager.util.Token( "<init>(Lcom.objectspace.jgl.SListIterator;)" );
  ...
  private static final com.objectspace.voyager.util.Token __instance11 = new com.objectspace.voyager.util.Token( "distance(Lcom.objectspace.jgl.ForwardIterator;)I" );
  private static final com.objectspace.voyager.util.Token __instance12 = new com.objectspace.voyager.util.Token( "index()I" );
  private static final com.objectspace.voyager.util.Token __instance13 = new com.objectspace.voyager.util.Token( "getContainer()Lcom.objectspace.jgl.Container;" );
  ...
  private static final com.objectspace.voyager.util.Token __instance15 = new com.objectspace.voyager.util.Token( "opaqueData()Ljava.lang.Object;" );
  private static final com.objectspace.voyager.util.Token __instance16 = new com.objectspace.voyager.util.Token( "opaqueId()I" );
  
  static
    {
    __register( new VSListIterator() );
    }
  ...
  public String getOriginalClassName()
    {
    return "com.objectspace.jgl.SListIterator";
    }
   ...
   * @exception com.objectspace.voyager.VoyagerException A voyager-related exception occurred.
   */
  public VSListIterator( String __address, long __timeout ) throws com.objectspace.voyager.VoyagerException
    {
   ...
   * @exception com.objectspace.voyager.VoyagerException A voyager-related exception occurred.
   */
  public VSListIterator( String __address ) throws com.objectspace.voyager.VoyagerException
    {
   ...
   * @exception com.objectspace.voyager.VoyagerException A voyager-related exception occurred.
   */
  public VSListIterator( com.objectspace.jgl.SListIterator arg1, String __address, long __timeout ) throws com.objectspace.voyager.VoyagerException
    {
    com.objectspace.voyager.message.Messenger __messenger = __newConstructorDefaultMessenger();
   ...
   * @exception com.objectspace.voyager.VoyagerException A voyager-related exception occurred.
   */
  public VSListIterator( com.objectspace.jgl.SListIterator arg1, String __address ) throws com.objectspace.voyager.VoyagerException
    {
