...
public class VBidirectionalIterator extends com.objectspace.voyager.VObject implements com.objectspace.jgl.BidirectionalIterator
  {
  private static final com.objectspace.voyager.util.Token __classname = new com.objectspace.voyager.util.Token( "com.objectspace.jgl.BidirectionalIterator" );
  ...
  private static final com.objectspace.voyager.util.Token __instance1 = new com.objectspace.voyager.util.Token( "retreat()V" );
  private static final com.objectspace.voyager.util.Token __instance2 = new com.objectspace.voyager.util.Token( "retreat(I)V" );
  ...
  private static final com.objectspace.voyager.util.Token __instance5 = new com.objectspace.voyager.util.Token( "get(I)Ljava.lang.Object;" );
  private static final com.objectspace.voyager.util.Token __instance6 = new com.objectspace.voyager.util.Token( "put(ILjava.lang.Object;)V" );
  private static final com.objectspace.voyager.util.Token __instance7 = new com.objectspace.voyager.util.Token( "distance(Lcom.objectspace.jgl.ForwardIterator;)I" );
  private static final com.objectspace.voyager.util.Token __instance8 = new com.objectspace.voyager.util.Token( "getContainer()Lcom.objectspace.jgl.Container;" );
  private static final com.objectspace.voyager.util.Token __instance9 = new com.objectspace.voyager.util.Token( "atBegin()Z" );
  private static final com.objectspace.voyager.util.Token __instance10 = new com.objectspace.voyager.util.Token( "atEnd()Z" );
  ...
  private static final com.objectspace.voyager.util.Token __instance12 = new com.objectspace.voyager.util.Token( "isCompatibleWith(Lcom.objectspace.jgl.InputIterator;)Z" );
  private static final com.objectspace.voyager.util.Token __instance13 = new com.objectspace.voyager.util.Token( "hasMoreElements()Z" );
  private static final com.objectspace.voyager.util.Token __instance14 = new com.objectspace.voyager.util.Token( "nextElement()Ljava.lang.Object;" );
  private static final com.objectspace.voyager.util.Token __instance15 = new com.objectspace.voyager.util.Token( "put(Ljava.lang.Object;)V" );
  
  static
    {
    __register( new VBidirectionalIterator() );
    }
  ...
  public String getOriginalClassName()
    {
    return "com.objectspace.jgl.BidirectionalIterator";
    }
   ...
   */
  public VBidirectionalIterator( com.objectspace.voyager.space.VSubspace reference ) throws com.objectspace.voyager.VoyagerException
    {
