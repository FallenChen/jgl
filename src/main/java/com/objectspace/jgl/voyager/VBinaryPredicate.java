...
public class VBinaryPredicate extends com.objectspace.voyager.VObject implements com.objectspace.jgl.BinaryPredicate
  {
  private static final com.objectspace.voyager.util.Token __classname = new com.objectspace.voyager.util.Token( "com.objectspace.jgl.BinaryPredicate" );
  private static final com.objectspace.voyager.util.Token __instance0 = new com.objectspace.voyager.util.Token( "execute(Ljava.lang.Object;Ljava.lang.Object;)Z" );
  
  static
    {
    __register( new VBinaryPredicate() );
    }
   ...
   */
  public VBinaryPredicate( com.objectspace.voyager.space.VSubspace reference ) throws com.objectspace.voyager.VoyagerException
    {
  ...
  public boolean execute( Object arg1, Object arg2 )
    {
